...
In Claude Code, Skills can install packages from npm and PyPI as needed. List required packages in your SKILL.md.

**Best practices:**
- Install packages locally (avoid global installation)
- Specify exact versions for reproducibility
- Document installation steps clearly

### Runtime environment

Skills in Claude Code run in the user's local environment with filesystem access, bash commands, and code execution capabilities.
